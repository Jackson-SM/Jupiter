...
import { RemoveResponsibleCase } from "./remove-responsible-case";
...
describe("Find Task By Id Case", () => {
  ...
  let removeResponsibleCase: RemoveResponsibleCase;
  ...
  beforeEach(async () => {
    ...
    removeResponsibleCase = new RemoveResponsibleCase(inMemoryTaskRepository);
